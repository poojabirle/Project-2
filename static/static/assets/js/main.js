...
(function ($) {
	...
	jQuery(document).ready(function ($) {
		...
		*/
		...
		$(".feature-option .feature-toggle").on("click", function () {
			$(".feature-overlay").toggleClass("feature-overlay-active");
		});
		$(".feature-overlay-close").on("click", function () {
			$(".feature-overlay").removeClass("feature-overlay-active");
		});
